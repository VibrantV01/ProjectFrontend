...
import {createTask, deleteTask, showtask, updatetask, edittask, searchTask, sorttask, filterTask} from '../Reducer/actions';
...
export default function UserTask(){
    ...
    function handleSubmit(event){
        ...
        // axios.get('http://localhost:8002/showtasks/' + user.currentUser.user.id).then (
        //     (response) => {
        //         dispatch(addTasks(
        //             {
    ...
    //         }
    //     }
    //     axios.put('http://localhost:8002/edittask/' + id, null, data).then(
    //         (response) => {
    //             console.log(response);
    //         },
    //         (error) => {
